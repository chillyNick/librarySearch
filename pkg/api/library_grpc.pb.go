...
func (c *libraryServiceClient) GetBooks(ctx context.Context, in *Author, opts ...grpc.CallOption) (*Books, error) {
	out := new(Books)
	err := c.cc.Invoke(ctx, "/api.LibraryService/GetBooks", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *libraryServiceClient) GetAuthors(ctx context.Context, in *Book, opts ...grpc.CallOption) (*Authors, error) {
	out := new(Authors)
	err := c.cc.Invoke(ctx, "/api.LibraryService/GetAuthors", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedLibraryServiceServer) GetBooks(context.Context, *Author) (*Books, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBooks not implemented")
}
func (UnimplementedLibraryServiceServer) GetAuthors(context.Context, *Book) (*Authors, error) {
...
func _LibraryService_GetBooks_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.LibraryService/GetBooks",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LibraryServiceServer).GetBooks(ctx, req.(*Author))
	}
...
func _LibraryService_GetAuthors_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/api.LibraryService/GetAuthors",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(LibraryServiceServer).GetAuthors(ctx, req.(*Book))
	}
	return interceptor(ctx, in, info, handler)
}
...
var LibraryService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "api.LibraryService",
